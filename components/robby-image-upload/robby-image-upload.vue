<template>
  <view class="imageUploadContainer">
    <view class="imageUploadList">
      ...
      <view v-if="isShowAdd"
            class="imageUpload"
            @tap="selectImage">+</view>
    </view>
    <image v-if="showMoveImage"
           class="moveImage"
           :style="{left:posMoveImageLeft, top:posMoveImageTop}"
           :src="moveImagePath"></image>
  </view>
</template>
                ...
                uni.uploadFile({
                  ...
                  success: function (res) {
                    if (res.statusCode === 200)
                    {
                      ...
                      console.log('success to upload image: ' + JSON.parse(res.data).data.fullurl)
...
.imageDel {
  ...
  width: 36upx;
  height: 36upx;
  background: url(@/static/imgs/public/close.png) no-repeat;
  background-size: 100%;
}
