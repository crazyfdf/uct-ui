<template name="w-picker">
  <view class="w-picker"
    ...
    <view class="w-picker-cnt"
      ...
      <shortterm-picker v-if="mode=='shortTerm'"
                        class="w-picker-wrapper"
                        :startYear="startYear"
                        :endYear="endYear"
                        :value="value"
      ...
      <linkage-picker v-if="mode=='linkage'"
                      class="w-picker-wrapper"
                      :value="value"
                      :options="options"
                      :level="level"
...
export default {
  ...
  methods: {
    ...
    touchEnd () {
      if (this.timeout)
      {
        this.$tools.showLoading('', true, 1500)
        setTimeout(() => {
