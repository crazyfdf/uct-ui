<template>
	<view class="">
		...
		>
			<view class="uct-status-bar" :style="{ height: statusBarHeight + 'px' }"></view>
			<view class="uct-navbar-inner" :style="[navbarInnerStyle]">
				<!-- @slot 自定义导航栏内容插槽，设置custom为true是生效 -->
				<slot v-if="custom"></slot>
				<view v-else class="uct-navbar-inner">
					...
					<view class="uct-slot-content f16 f700" :style="{ maxWidth: titleWidth + 'rpx' }">
