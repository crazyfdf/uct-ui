<template>
  <view class="uct-slider"
        @tap="onClick"
        :class="[disabled ? 'uct-slider--disabled' : '']"
        :style="{
		backgroundColor: inactiveColor
	}">
    <view class="uct-slider__gap"
          :style="[
				barStyle,
				{
					height: height + 'rpx',
      ...
      <view class="uct-slider__button-wrap"
...
export default {
  ...
  mounted() {
    // 获取滑块条的尺寸信息
    this.$uGetRect(".uct-slider").then((rect) => {
